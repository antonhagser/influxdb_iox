...
async fn random_backfill_over_l2s() {
    ...
    - "  Creating 8 files"
    - "**** Simulation run 15, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[279, 516]). 6 Input Files, 266mb total:"
    - "L0                                                                                                                 "
    ...
    - "L1                                                                                                                 "
    - "L1.?[42,279] 1.04us 100mb|-------------L1.?--------------|                                                         "
    - "L1.?[280,516] 1.04us 100mb                                  |-------------L1.?--------------|                       "
    - "L1.?[517,672] 1.04us 66mb                                                                   |--------L1.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L0.75, L1.81, L1.82, L0.84, L0.86, L0.87"
    - "  Creating 3 files"
    - "**** Simulation run 16, type=split(ReduceOverlap)(split_times=[279]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.78[42,356] 1.05us     |-----------------------------------------L0.78------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[42,279] 1.05us 25mb |------------------------------L0.?-------------------------------|                       "
    - "L0.?[280,356] 1.05us 8mb                                                                     |-------L0.?--------| "
    - "**** Simulation run 17, type=split(ReduceOverlap)(split_times=[516]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.91[358,670] 1.05us    |-----------------------------------------L0.91------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[358,516] 1.05us 17mb|-------------------L0.?--------------------|                                             "
    - "L0.?[517,670] 1.05us 16mb                                             |-------------------L0.?-------------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.78, L0.91"
    - "  Creating 4 files"
    - "**** Simulation run 18, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[908]). 2 Input Files, 134mb total:"
    - "L0                                                                                                                 "
    ...
    - "L1                                                                                                                 "
    - "L1.?[673,908] 1.04us 100mb|------------------------------L1.?-------------------------------|                       "
    - "L1.?[909,986] 1.04us 33mb                                                                   |--------L1.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L1.83, L0.85"
    - "  Creating 2 files"
    - "**** Simulation run 19, type=split(ReduceOverlap)(split_times=[908]). 1 Input Files, 33mb total:"
    - "L0, all files 33mb                                                                                                 "
    - "L0.89[673,986] 1.05us    |-----------------------------------------L0.89------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 33mb total:"
    - "L0                                                                                                                 "
    - "L0.?[673,908] 1.05us 25mb|------------------------------L0.?-------------------------------|                       "
    - "L0.?[909,986] 1.05us 8mb                                                                    |--------L0.?--------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L0.89"
    - "  Creating 2 files"
    - "**** Simulation run 20, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[232, 422]). 6 Input Files, 250mb total:"
    - "L0                                                                                                                 "
    - "L0.95[42,279] 1.05us 25mb|-------------------L0.95-------------------|                                             "
    - "L0.96[280,356] 1.05us 8mb                                             |---L0.96----|                               "
    - "L0.90[357,357] 1.05us 0b                                                            |L0.90|                        "
    - "L0.97[358,516] 1.05us 17mb                                                            |-----------L0.97------------|"
    - "L1                                                                                                                 "
    - "L1.92[42,279] 1.04us 100mb|-------------------L1.92-------------------|                                             "
    - "L1.93[280,516] 1.04us 100mb                                             |------------------L1.93-------------------| "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 250mb total:"
    - "L1                                                                                                                 "
    - "L1.?[42,232] 1.05us 100mb|---------------L1.?---------------|                                                      "
    - "L1.?[233,422] 1.05us 100mb                                    |--------------L1.?---------------|                   "
    - "L1.?[423,516] 1.05us 50mb                                                                        |-----L1.?------| "
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L0.90, L1.92, L1.93, L0.95, L0.96, L0.97"
    - "  Creating 3 files"
    - "**** Simulation run 21, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[705, 893]). 7 Input Files, 250mb total:"
    - "L0                                                                                                                 "
    - "L0.102[909,986] 1.05us 8mb                                                                           |---L0.102---| "
    - "L0.101[673,908] 1.05us 25mb                             |------------------L0.101-------------------|                "
    - "L0.88[671,672] 1.05us 109kb                             |L0.88|                                                      "
    - "L0.98[517,670] 1.05us 16mb|-----------L0.98-----------|                                                             "
    - "L1                                                                                                                 "
    - "L1.100[909,986] 1.04us 33mb                                                                           |---L1.100---| "
    - "L1.99[673,908] 1.04us 100mb                             |-------------------L1.99-------------------|                "
    - "L1.94[517,672] 1.04us 66mb|-----------L1.94-----------|                                                             "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 250mb total:"
    - "L1                                                                                                                 "
    - "L1.?[517,705] 1.05us 100mb|---------------L1.?---------------|                                                      "
    - "L1.?[706,893] 1.05us 100mb                                    |--------------L1.?---------------|                   "
    - "L1.?[894,986] 1.05us 50mb                                                                        |-----L1.?------| "
    - "Committing partition 1:"
    - "  Soft Deleting 7 files: L0.88, L1.94, L0.98, L1.99, L1.100, L0.101, L0.102"
    - "  Creating 3 files"
    - "**** Simulation run 22, type=split(ReduceOverlap)(split_times=[299, 399]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.104[233,422] 1.05us   |-----------------------------------------L1.104-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[233,299] 1.05us 35mb|------------L1.?-------------|                                                           "
    - "L1.?[300,399] 1.05us 52mb                               |--------------------L1.?---------------------|            "
    - "L1.?[400,422] 1.05us 13mb                                                                               |--L1.?--| "
    - "**** Simulation run 23, type=split(ReduceOverlap)(split_times=[99, 199]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.103[42,232] 1.05us    |-----------------------------------------L1.103-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[42,99] 1.05us 30mb  |----------L1.?-----------|                                                               "
    - "L1.?[100,199] 1.05us 52mb                           |--------------------L1.?--------------------|                 "
    - "L1.?[200,232] 1.05us 18mb                                                                          |----L1.?-----| "
    - "**** Simulation run 24, type=split(ReduceOverlap)(split_times=[499]). 1 Input Files, 50mb total:"
    - "L1, all files 50mb                                                                                                 "
    - "L1.105[423,516] 1.05us   |----------------------------------------L1.105-----------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 50mb total:"
    - "L1                                                                                                                 "
    - "L1.?[423,499] 1.05us 41mb|---------------------------------L1.?----------------------------------|                 "
    - "L1.?[500,516] 1.05us 9mb                                                                           |----L1.?-----| "
    - "**** Simulation run 25, type=split(ReduceOverlap)(split_times=[899]). 1 Input Files, 50mb total:"
    - "L1, all files 50mb                                                                                                 "
    - "L1.108[894,986] 1.05us   |-----------------------------------------L1.108-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 50mb total:"
    - "L1                                                                                                                 "
    - "L1.?[894,899] 1.05us 3mb |L1.?|                                                                                    "
    - "L1.?[900,986] 1.05us 47mb     |---------------------------------------L1.?---------------------------------------| "
    - "**** Simulation run 26, type=split(ReduceOverlap)(split_times=[799]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.107[706,893] 1.05us   |----------------------------------------L1.107-----------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[706,799] 1.05us 50mb|-------------------L1.?-------------------|                                              "
    - "L1.?[800,893] 1.05us 50mb                                             |-------------------L1.?-------------------| "
    - "**** Simulation run 27, type=split(ReduceOverlap)(split_times=[599, 699]). 1 Input Files, 100mb total:"
    - "L1, all files 100mb                                                                                                "
    - "L1.106[517,705] 1.05us   |-----------------------------------------L1.106-----------------------------------------|"
    - "**** 3 Output Files (parquet_file_id not yet assigned), 100mb total:"
    - "L1                                                                                                                 "
    - "L1.?[517,599] 1.05us 44mb|----------------L1.?-----------------|                                                   "
    - "L1.?[600,699] 1.05us 53mb                                       |--------------------L1.?---------------------|    "
    - "L1.?[700,705] 1.05us 4mb                                                                                        |L1.?|"
    - "Committing partition 1:"
    - "  Soft Deleting 6 files: L1.103, L1.104, L1.105, L1.106, L1.107, L1.108"
    - "  Creating 15 files"
    - "**** Simulation run 28, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[71, 142]). 4 Input Files, 282mb total:"
    - "L1                                                                                                                 "
    - "L1.112[42,99] 1.05us 30mb                  |--------L1.112---------|                                               "
    - "L1.113[100,199] 1.05us 52mb                                             |------------------L1.113------------------| "
    - "L2                                                                                                                 "
    - "L2.1[0,99] 99ns 100mb    |-------------------L2.1-------------------|                                              "
    - "L2.2[100,199] 199ns 100mb                                             |-------------------L2.2-------------------| "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 4 files: L2.1, L2.2, L1.112, L1.113"
    - "  Creating 3 files"
    - "**** Simulation run 29, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[265]). 3 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.114[200,232] 1.05us 18mb|----------L1.114-----------|                                                             "
    - "L1.109[233,299] 1.05us 35mb                             |-------------------------L1.109--------------------------|  "
    - "L2                                                                                                                 "
    - "L2.3[200,299] 299ns 100mb|-----------------------------------------L2.3------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 153mb total:"
    - "L2                                                                                                                 "
    - "L2.?[200,265] 1.05us 100mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[266,299] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.3, L1.109, L1.114"
    - "  Creating 2 files"
    - "**** Simulation run 30, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[366]). 2 Input Files, 152mb total:"
    - "L1                                                                                                                 "
    - "L1.110[300,399] 1.05us 52mb|----------------------------------------L1.110-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.4[300,399] 399ns 100mb|-----------------------------------------L2.4------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 152mb total:"
    - "L2                                                                                                                 "
    - "L2.?[300,366] 1.05us 101mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[367,399] 1.05us 51mb                                                            |-----------L2.?------------| "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L2.4, L1.110"
    - "  Creating 2 files"
    - "**** Simulation run 31, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[465]). 3 Input Files, 154mb total:"
    - "L1                                                                                                                 "
    - "L1.111[400,422] 1.05us 13mb|------L1.111------|                                                                      "
    - "L1.115[423,499] 1.05us 41mb                    |------------------------------L1.115-------------------------------| "
    - "L2                                                                                                                 "
    - "L2.5[400,499] 499ns 100mb|-----------------------------------------L2.5------------------------------------------| "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.5, L1.111, L1.115"
    - "  Creating 2 files"
    - "**** Simulation run 32, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[565]). 3 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.116[500,516] 1.05us 9mb|---L1.116---|                                                                            "
    - "L1.121[517,599] 1.05us 44mb               |---------------------------------L1.121---------------------------------| "
    - "L2                                                                                                                 "
    - "L2.6[500,599] 599ns 100mb|-----------------------------------------L2.6------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 153mb total:"
    - "L2                                                                                                                 "
    - "L2.?[500,565] 1.05us 100mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[566,599] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.6, L1.116, L1.121"
    - "  Creating 2 files"
    - "**** Simulation run 33, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[665]). 2 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.122[600,699] 1.05us 53mb|----------------------------------------L1.122-----------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.7[600,699] 699ns 100mb|-----------------------------------------L2.7------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 153mb total:"
    - "L2                                                                                                                 "
    - "L2.?[600,665] 1.05us 100mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[666,699] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L2.7, L1.122"
    - "  Creating 2 files"
    - "**** Simulation run 34, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[765]). 3 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.123[700,705] 1.05us 4mb|L1.123|                                                                                  "
    - "L1.119[706,799] 1.05us 50mb     |--------------------------------------L1.119--------------------------------------| "
    - "L2                                                                                                                 "
    - "L2.8[700,799] 799ns 100mb|-----------------------------------------L2.8------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 153mb total:"
    - "L2                                                                                                                 "
    - "L2.?[700,765] 1.05us 101mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[766,799] 1.05us 53mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.8, L1.119, L1.123"
    - "  Creating 2 files"
    - "**** Simulation run 35, type=split(CompactAndSplitOutput(FoundSubsetLessThanMaxCompactSize))(split_times=[865]). 3 Input Files, 153mb total:"
    - "L1                                                                                                                 "
    - "L1.120[800,893] 1.05us 50mb|--------------------------------------L1.120--------------------------------------|      "
    - "L1.117[894,899] 1.05us 3mb                                                                                     |L1.117|"
    - "L2                                                                                                                 "
    - "L2.9[800,899] 899ns 100mb|-----------------------------------------L2.9------------------------------------------| "
    - "**** 2 Output Files (parquet_file_id not yet assigned), 153mb total:"
    - "L2                                                                                                                 "
    - "L2.?[800,865] 1.05us 100mb|--------------------------L2.?---------------------------|                               "
    - "L2.?[866,899] 1.05us 52mb                                                           |-----------L2.?------------|  "
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L2.9, L1.117, L1.120"
    - "  Creating 2 files"
    - "**** Final Output Files (4.19gb written)"
    - "L1                                                                                                                 "
    - "L1.118[900,986] 1.05us 47mb                                                                                 |L1.118| "
    - "L2                                                                                                                 "
    - "L2.10[900,999] 999ns 100mb                                                                                 |L2.10-| "
    - "L2.124[0,71] 1.05us 101mb|L2.124|                                                                                  "
    - "L2.125[72,142] 1.05us 99mb      |L2.125|                                                                            "
    - "L2.126[143,199] 1.05us 82mb            |L2.126|                                                                      "
    - "L2.127[200,265] 1.05us 100mb                  |L2.127|                                                                "
    - "L2.128[266,299] 1.05us 52mb                       |L2.128|                                                           "
    - "L2.129[300,366] 1.05us 101mb                           |L2.129|                                                       "
    - "L2.130[367,399] 1.05us 51mb                                 |L2.130|                                                 "
    - "L2.131[400,465] 1.05us 101mb                                    |L2.131|                                              "
    - "L2.132[466,499] 1.05us 53mb                                         |L2.132|                                         "
    - "L2.133[500,565] 1.05us 100mb                                             |L2.133|                                     "
    - "L2.134[566,599] 1.05us 52mb                                                  |L2.134|                                "
    - "L2.135[600,665] 1.05us 100mb                                                      |L2.135|                            "
    - "L2.136[666,699] 1.05us 52mb                                                            |L2.136|                      "
    - "L2.137[700,765] 1.05us 101mb                                                               |L2.137|                   "
    - "L2.138[766,799] 1.05us 53mb                                                                     |L2.138|             "
    - "L2.139[800,865] 1.05us 100mb                                                                        |L2.139|          "
    - "L2.140[866,899] 1.05us 52mb                                                                              |L2.140|    "
    "###
    );
}
