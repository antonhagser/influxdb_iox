...
async fn many_good_size_l0_files() {
    ...
    - "**** Simulation run 0, type=split(VerticalSplit)(split_times=[96]). 1 Input Files, 2mb total:"
    - "L0, all files 2mb                                                                                                  "
    - "L0.97[96,97] 97ns        |-----------------------------------------L0.97------------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 2mb total:"
    - "L0                                                                                                                 "
    - "L0.?[96,96] 97ns 0b      |L0.?|                                                                                    "
    - "L0.?[97,97] 97ns 2mb                                                                                               |L0.?|"
    - "**** Simulation run 1, type=split(VerticalSplit)(split_times=[192]). 1 Input Files, 2mb total:"
    - "L0, all files 2mb                                                                                                  "
    - "L0.193[192,193] 193ns    |-----------------------------------------L0.193-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 2mb total:"
    - "L0                                                                                                                 "
    - "L0.?[192,192] 193ns 0b   |L0.?|                                                                                    "
    - "L0.?[193,193] 193ns 2mb                                                                                            |L0.?|"
    - "Committing partition 1:"
    - "  Soft Deleting 2 files: L0.97, L0.193"
    - "  Creating 4 files"
    ...
    - "L0.96[95,96] 96ns 2mb                                                             |L0.96|                          "
    - "L0.289[96,96] 97ns 0b                                                             |L0.289|                         "
    - "L0.290[97,97] 97ns 2mb                                                             |L0.290|                        "
    ...
    - "L0.291[192,192] 193ns 0b                                                        |L0.291|                           "
    - "L0.292[193,193] 193ns 2mb                                                       |L0.292|                           "
    ...
    - "L1                                                                                                                 "
    - "L1.295[101,150] 150ns 102mb|----------L1.295-----------|                                                             "
    - "**** 3 Output Files (parquet_file_id not yet assigned), 300mb total:"
    - "L1                                                                                                                 "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 101 files: L0.151, L0.152, L0.153, L0.154, L0.155, L0.156, L0.157, L0.158, L0.159, L0.160, L0.161, L0.162, L0.163, L0.164, L0.165, L0.166, L0.167, L0.168, L0.169, L0.170, L0.171, L0.172, L0.173, L0.174, L0.175, L0.176, L0.177, L0.178, L0.179, L0.180, L0.181, L0.182, L0.183, L0.184, L0.185, L0.186, L0.187, L0.188, L0.189, L0.190, L0.191, L0.192, L0.194, L0.195, L0.196, L0.197, L0.198, L0.199, L0.200, L0.201, L0.202, L0.203, L0.204, L0.205, L0.206, L0.207, L0.208, L0.209, L0.210, L0.211, L0.212, L0.213, L0.214, L0.215, L0.216, L0.217, L0.218, L0.219, L0.220, L0.221, L0.222, L0.223, L0.224, L0.225, L0.226, L0.227, L0.228, L0.229, L0.230, L0.231, L0.232, L0.233, L0.234, L0.235, L0.236, L0.237, L0.238, L0.239, L0.240, L0.241, L0.242, L0.243, L0.244, L0.245, L0.246, L0.247, L0.248, L0.249, L0.291, L0.292, L1.295"
    - "  Creating 3 files"
    - "**** Simulation run 4, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[251]). 40 Input Files, 177mb total:"
    - "L0                                                                                                                 "
    ...
    - "Committing partition 1:"
    - "  Soft Deleting 3 files: L1.294, L1.296, L1.297"
    - "  Upgrading 1 files level to CompactionLevel::L2: L1.293"
    - "  Creating 3 files"
    - "**** Simulation run 6, type=split(CompactAndSplitOutput(TotalSizeLessThanMaxCompactSize))(split_times=[280]). 1 Input Files, 76mb total:"
    - "L1, all files 76mb                                                                                                 "
    - "L1.300[252,288] 288ns    |-----------------------------------------L1.300-----------------------------------------|"
    - "**** 2 Output Files (parquet_file_id not yet assigned), 76mb total:"
    - "L2                                                                                                                 "
    - "L2.?[252,280] 288ns 59mb |--------------------------------L2.?--------------------------------|                    "
    - "L2.?[281,288] 288ns 17mb                                                                         |-----L2.?------| "
    - "Committing partition 1:"
    - "  Soft Deleting 1 files: L1.300"
    - "  Upgrading 1 files level to CompactionLevel::L2: L1.299"
    - "  Creating 2 files"
    - "**** Final Output Files (1.13gb written)"
    - "L2                                                                                                                 "
    - "L2.293[0,50] 150ns 100mb |---L2.293----|                                                                           "
    - "L2.299[202,251] 288ns 101mb                                                               |---L2.299----|            "
    - "L2.301[51,102] 249ns 102mb               |---L2.301----|                                                            "
    - "L2.302[103,153] 249ns 100mb                                |---L2.302----|                                           "
    - "L2.303[154,201] 249ns 98mb                                                |---L2.303---|                            "
    - "L2.304[252,280] 288ns 59mb                                                                              |L2.304|    "
    - "L2.305[281,288] 288ns 17mb                                                                                       |L2.305|"
    "###
    );
}
